...
public class User {
    ...
    public static void updateForgetPassword(String username, String pass) throws SQLException {
     ...
     public static boolean checkUsername(String username) {
        ...
        try {
            Statement st = DBManagement.getCn().createStatement();
            ResultSet rs = st.executeQuery("select * from Buser where Username='" + username + "'");
            rs.next();
            if (rs.getString("Username").equals(username)) {
                result = false;
            }
    ...
    public static void Register(String user, String stdId, String name, String surname, String depart,
            String email, String pass, String qus, String ans) throws SQLException {

        Statement st = DBManagement.getCn().createStatement();
        String sql = "insert into Buser(Username,StudentID,Firstname,Surname,Department,Email"
                + ",Password,Security_Question,Security_Answer)"
                + "values ('" + user + "'," + stdId + ",'" + name + "','" + surname + "','"
                + depart + "','" + email + "','" + pass + "','" + qus + "','" + ans + "') ";
        st.executeUpdate(sql);
    }
